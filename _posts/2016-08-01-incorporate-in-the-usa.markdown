...
permalink: /blog/how-to-incorporate-in-the-us-from-outside-the-usa-version-3/
redirect_from:
  - blog/how-to-incorporate-in-the-us-from-oustside-the-usa-v3
  - /blog/how-to-incorporate-in-the-us-from-outside-the-usa-v3
...
If you are not based in the US and have a US based company via the Stripe atlas program or if you have a Stripe atlas invite , we have created an [unofficial stripe atlas entrepreneurs group in Facebook](https://www.facebook.com/groups/1751531058421877/) . You are not alone here, if you run into any issues or need help you can ask other fellow atlas entrepreneurs for help.
